...
class AnimatedSprite:
    def __init__(self):
        ...
        anim_configs = {
            ...
            'death': {'folder': 'Vampires1_Death_without_shadow.png', 'frames': 11, 'prefix': '{dir}{i}.jpg'},
        }
...
while running:
    ...
    screen.blit(sprite.get_image(), (player_x - camera_x, player_y - camera_y))
    ...
    for pid, pos in players.items():
        ...
        screen.blit(other_sprites[pid].get_image(), (pos['x'] - camera_x, pos['y'] - camera_y))
